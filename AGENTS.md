...
2. [docs/decisions/030-architecture-style.md](docs/decisions/030-architecture-style.md) — pure core, trait ports
3. [docs/decisions/029-testing-strategy.md](docs/decisions/029-testing-strategy.md) — test pyramid
