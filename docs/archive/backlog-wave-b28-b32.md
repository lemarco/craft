...
| **B-31** | **Founder scale** + **`trembita doctor`** foot-guns | [capability-dx § Founder scale](../decisions/capability-dx.md#founder-scale-model-b-31) | [`cap_scale_doctor.rs`](../../crates/trembita-cli/tests/cap_scale_doctor.rs) |
