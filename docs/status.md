...
| **B-38** | **Founder DX v2** — `doctor --explain-scale`, lint v2 `suggestion`, `new --profile`, jobs **`task.rs`** R4 scaffold | [capability-dx § B-38](decisions/capability-dx.md#founder-dx-v2-b-38) · [capabilities § B-38](scenarios/capabilities.md#founder-dx-v2-b-38) · [runbook § B-38](ops/production-runbook.md#founder-dx-v2-b-38) | [`doctor.rs`](../crates/trembita-cli/src/scaffold/doctor.rs) (`b38_*`), [`template.rs`](../crates/trembita-cli/src/scaffold/template.rs) (`b38_*`), [`task.rs.tpl`](../crates/trembita-cli/templates/trembita-app/src/capabilities/task.rs.tpl), [`scaffold.rs`](../crates/trembita-cli/tests/scaffold.rs), [`cap_scale_doctor.rs`](../crates/trembita-cli/tests/cap_scale_doctor.rs) (`b38_*`) |
| **B-39** | **Local 3-node cluster (founder)** — `founder-cluster.sh`, `dev cluster-up`, shared session secret, optional nginx **:18290** | [founder-3node](../dev/founder-3node/README.md) · [capabilities § B-39](scenarios/capabilities.md#local-3-node-founder-cluster-b-39) · [capability-dx § B-39](decisions/capability-dx.md#local-3-node-cluster-b-39) | [`founder.rs`](../crates/trembita-cli/src/dev/founder.rs) (`b39_*`), [`showcases.rs`](../crates/trembita-cli/src/dev/showcases.rs), [`cluster.rs`](../crates/trembita-cli/src/dev/cluster.rs), [`dev.rs`](../crates/trembita-cli/tests/dev.rs), [`founder-cluster.sh`](../scripts/founder-cluster.sh) |
