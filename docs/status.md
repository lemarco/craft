...
| **B-42** | **Local elastic parity** — staged **4th joiner**, nginx **3/4** upstreams, `elastic-smoke` / **`GET /e2e/whoami`** on **realtime** (mirrors [B-34](scenarios/capabilities.md#elastic-join--lb-b-34) on a laptop) | [local-3node § B-42](../dev/local-3node/README.md#local-elastic-parity-b-42) · [capabilities § B-42](scenarios/capabilities.md#local-elastic-parity-b-42) · [capability-dx § B-42](decisions/capability-dx.md#local-elastic-parity-b-42) | [`local_cluster.rs`](../crates/trembita-cli/src/dev/local_cluster.rs) (`b42_*`), [`cluster.rs`](../crates/trembita-cli/src/dev/cluster.rs), [`tests/dev.rs`](../crates/trembita-cli/tests/dev.rs) (`b42_*`), [`e2e_elastic/gateway.rs`](../crates/trembita-tools/src/e2e_elastic/gateway.rs) (`b42_*`), [`examples/realtime`](../examples/realtime/src/main.rs), [`local-cluster.sh`](../scripts/local-cluster.sh) |
