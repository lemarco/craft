...
| P12 | **Tier 2 multi-Raft architecture** ([tier2-multi-raft-architecture](decisions/tier2-multi-raft-architecture.md)) | **partial** | Phase 1–3 landed (planners, dynamic catalog, stable shard wiring). Phase 4 cross-shard tx — open. |
