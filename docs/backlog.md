...
| P6 | **Write sharding / multi-Raft** ([ADR 031](decisions/031-write-sharding-multi-raft.md)) | **builder wired** | Routing + runtime + `CraftClusterBuilder::raft_machines` / keyed client APIs; integration tests. Deferred: per-group redb namespacing, rebalancing control plane. |
