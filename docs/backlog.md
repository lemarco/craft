...
| C3 | rustls mTLS peers; **dedicated peer connection** ([ADR 027](decisions/027-future-work-and-risks.md) R2) | L | partial (mTLS config + cert gen done; QUIC endpoint wiring with C2) |
