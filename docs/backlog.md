...
| P12 | **Tier 2 multi-Raft architecture** ([tier2-multi-raft-architecture](decisions/tier2-multi-raft-architecture.md)) | **done** | Phases 1–4 + tails: `catalog_version`, `switch_to_stable_shards`, saga hardening. Optional 2PC deferred. |
