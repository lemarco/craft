...
| P6 | **Write sharding / multi-Raft** ([ADR 031](decisions/031-write-sharding-multi-raft.md)) | **done** | Routing, runtime, builder, keyed client APIs, per-group `GroupRedbLayout` / `data_dir`. Deferred: rebalancing control plane. |
