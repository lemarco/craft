...
| P12 | **Tier 2 multi-Raft architecture** ([tier2-multi-raft-architecture](decisions/tier2-multi-raft-architecture.md)) | **partial** | Phase 1: pure planners (`StableShardRouter`, `validate_catalog`, `plan_catalog_expansion`) + [cross-shard-transactions](decisions/cross-shard-transactions.md) ADR. Phase 2–4: dynamic catalog runtime, stable shard wiring, saga/2PC — open. |
