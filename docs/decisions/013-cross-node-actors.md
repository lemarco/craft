...
All routes: mTLS peer auth ([ADR 006](006-security.md)).
...
**`scale_cluster` placement:** governed by [ADR 014](014-one-worker-per-vps.md).
...
- [019-cluster-routing.md](019-cluster-routing.md)
