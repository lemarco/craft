...
2. **`Transport` is a trait** ([ADR 010](010-wire-transport.md)). An in-memory implementation can inject delay/drop/partition without real sockets.
...
### CI mapping ([ADR 028](028-library-and-publishing.md))
...
- Jepsen / Antithesis-style external validation before a 1.0 stability claim (deferred, noted in [ADR 027](027-future-work-and-risks.md)).
