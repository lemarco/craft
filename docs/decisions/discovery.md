...
**Status:** Accepted  
**Date:** 2026-07-05  
**Updated:** 2026-07-05 — full joint-consensus membership early ([membership-early](membership-early.md))
...
| **Raft cluster config** | Authoritative peer list — **joint-consensus membership changes** ([membership-early](membership-early.md)) |
...
4. All nodes update peer map; QUIC pools connect; [auto-spawn-on-join](auto-spawn-on-join.md) spawns auto workers.
