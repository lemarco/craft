# ADR 026: Observability & monitoring (BEAM-style)
...
All read surfaces live on the **admin port** ([ADR 025](025-health-admin-port.md), default `:8080`), never on the mTLS craft wire.
...
| Store | redis_ops, redis_errors ([ADR 021](021-actor-state-redis.md)) |
...
Cross-node aggregation: admin queries fan out via existing actor directory ([ADR 013](013-cross-node-actors.md)) / peer RPC; leader can serve cluster-wide view.
...
- [025-health-admin-port.md](025-health-admin-port.md)
- [013-cross-node-actors.md](013-cross-node-actors.md)
- [018-supervisor-leader.md](018-supervisor-leader.md)
