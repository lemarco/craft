...
### Published (advanced): `trembita-assembly`
...
- On crates.io for framework authors; **product apps** should stay on **`trembita::`** re-exports — not part of the semver product contract ([public-api-1.0](public-api-1.0.md)).
