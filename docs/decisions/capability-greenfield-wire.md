...
- Optional builder flag [`without_actors_api`](../crates/trembita/src/app/builder.rs) becomes the recommended default for new templates when implemented (backlog).
