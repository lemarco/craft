...
Returns a task handle tracked in the cluster shutdown bundle (same as other background loops in [`builder.rs`](../../crates/trembita-assembly/src/builder/cluster/mod.rs)).
