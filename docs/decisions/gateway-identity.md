...
- [gateway-cluster-auth](gateway-cluster-auth.md) — cluster-verifiable session cookies (B-29); wave index [status § Product scale wave](../status.md#product-scale-wave-b-28b32)
