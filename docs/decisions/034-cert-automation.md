# ADR 034: mTLS cert automation (step-ca, cert-manager, hot reload)
...
[ADR 024](024-cert-provisioning.md) ships manual PKI (`examples/certs/generate.sh`,
`docs/certs.md`) and documents **rolling restart** rotation. [ADR 027](027-future-work-and-risks.md)
...
`clientAuth` EKU, and a SAN/CN of `craft-node-<NodeId>` ([ADR 006](006-security.md)).
...
Issued certs must match the existing contract ([ADR 024](024-cert-provisioning.md)):
...
| Admin HTTP POST | **no** | Admin port stays read-only ([ADR 025](025-health-admin-port.md)) |
...
- cert-manager and step-ca integrate without new wire protocol or ADR 006 changes
...
- [006-security.md](006-security.md) — mTLS policy
- [024-cert-provisioning.md](024-cert-provisioning.md) — v1 manual PKI
- [025-health-admin-port.md](025-health-admin-port.md) — admin stays read-only
- [027-future-work-and-risks.md](027-future-work-and-risks.md) — R6
