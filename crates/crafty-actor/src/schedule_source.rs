...
use crafty_proto::RecurringScheduleWire;
...
/// Fixed schedule list (used by [`.cron()`](../../crates/crafty/src/app.rs) at boot).
#[derive(Debug, Clone)]
...
impl RedbJobQueue {
    ...
    pub fn remove_schedule(&self, name: &str) -> Result<QueueReplicationOps, QueueError> {
        use super::queue_schedule::SCHEDULES_TABLE;
        use crafty_proto::QueueReplicateOp;
