...
use crate::{
    EventId, EventTopic, LeasedEvent, NOT_LEADER_REASON, RedbEventTopic, TopicError, TopicLeaseId,
    TopicMetrics, TopicReplicationOps, TopicSubscriptionDef, WorkerId,
};
                        ...
                        .await
                    {
                        Ok((events, ops)) => {
                            ...
                            TopicLeaseReply {
                                events: events
                                    .into_iter()
                                    .map(|e| crafty_proto::TopicLeasedEventWire {
                ...
                Ok(topic) => match topic.metrics().await {
                    Ok(m) => TopicMetricsReply {
                        ...
                        subscriptions: m
                            .subscriptions
                            .into_iter()
                            .map(|s| crafty_proto::TopicSubscriptionMetricsWire {
