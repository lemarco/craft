...
//!
//! crafty splits durable state in two:
//!
//! * **Consensus state** lives in the Raft [`StateMachine`](crafty_core::StateMachine)
...
//! (e.g. `crafty-store-redis`) live in their own crates.
//!
...
/// whole point of the external-store pattern. Use `crafty-store-redis` (or
