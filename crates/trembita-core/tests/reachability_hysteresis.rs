...
fn leader() -> trembita_core::RaftNode {
    let mut n = trembita_core::RaftNode::new(NodeId(1), [NodeId(1), NodeId(2), NodeId(3)], cfg());
    n.campaign();
...
fn ack(n: &mut trembita_core::RaftNode, from: u64, round: u64) {
    n.receive_reply(
        NodeId(from),
