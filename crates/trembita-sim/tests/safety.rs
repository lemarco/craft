...
use trembita_sim::{Cluster, Fault};
...
fn proptest_config() -> ProptestConfig {
    let cases = std::env::var("TREMBITA_PROptest_CASES")
        .ok()
...
proptest! {
    ...
    /// Thorough sweep: `TREMBITA_PROptest_CASES=250 cargo test -p trembita-sim --test safety`.
    #[test]
