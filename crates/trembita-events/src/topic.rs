...
//! independent cursors and lease/ack. Distinct from [`JobQueue`](trembita_jobs::JobQueue)
...
impl Default for TopicRetentionOpts {
    fn default() -> Self {
        Self {
            max_event_age: Duration::from_millis(trembita_proto::DEFAULT_TOPIC_MAX_EVENT_AGE_MS),
            max_retained_events: trembita_proto::DEFAULT_TOPIC_MAX_RETAINED_EVENTS,
        }
    }
}
