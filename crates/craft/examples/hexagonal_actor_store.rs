...
//! ```
//!
//! Run with: `cargo run -p craft --example hexagonal_actor_store`

use std::sync::Arc;
use std::time::Duration;

use craft::actor::{ActorRef, ActorStateStore, InMemoryStore, UserActor, store_get, store_set};
