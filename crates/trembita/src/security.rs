...
use trembita_net::tls::root_store;
use trembita_net::{NodeIdentity, PemMaterial, TlsError};
...
impl Security {
    ...
    /// Build from material loaded off disk ([`trembita_net::load_pem_material`]).
    #[must_use]
