//! Fluent builder for [`SagaPlan`](trembita_client::SagaPlan) ([workflows](../../../docs/scenarios/workflows.md)).

use std::collections::HashMap;

use trembita_client::{SagaPlan, SagaStep};
...
/// Fluent DSL that produces a [`SagaPlan`] for [`run_saga`](trembita_client::run_saga).
