...
impl<M: StateMachine> TrembitaObserver<M> {
...
fn actor_key(reg: &trembita_proto::ActorRegistration) -> String {
...
impl<M: StateMachine> Observer for TrembitaObserver<M> {
