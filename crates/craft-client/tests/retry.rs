...
use craft_client::{Client, ClientError, RemoteClient, RetryPolicy};
use craft_net::{LocalNetwork, Route, Transport, TransportError, encode_body};
use craft_proto::{ClientResponse, NodeId};
...
impl Transport for ScriptTransport {
    fn send(
        ...
        peer: NodeId,
        _route: Route,
        _body: craft_net::transport::Body,
    ) -> craft_net::transport::BoxFuture<'static, Result<craft_net::transport::Body, TransportError>>
    {
