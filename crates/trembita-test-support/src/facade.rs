//! Helpers for [`trembita::cluster::TrembitaCluster`] and [`trembita::TrembitaApp`] integration tests.
...
use trembita::TrembitaAppBuilder;
...
pub async fn wait_for_trembita_app_leader(app: &TrembitaApp) {
    for _ in 0..500 {
...
async fn is_group_leader<M>(cluster: &TrembitaCluster<M>, group: u32) -> bool
where
    M: StateMachine + Send + Sync + 'static,
{
