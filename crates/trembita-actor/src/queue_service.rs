...
fn job_status_to_list_entry(status: JobStatus) -> trembita_proto::QueueJobListEntryWire {
...
fn filter_from_list_request(request: &trembita_proto::QueueListJobsRequest) -> JobListFilter {
    JobListFilter {
