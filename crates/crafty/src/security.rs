...
use crafty_net::tls::root_store;
use crafty_net::{NodeIdentity, PemMaterial, TlsError};
...
impl Security {
    ...
    /// Build from material loaded off disk ([`crafty_net::load_pem_material`]).
    #[must_use]
