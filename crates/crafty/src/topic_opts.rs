//! Durable event topic registration options for [`CraftyAppBuilder`](super::app::CraftyAppBuilder).

use std::time::Duration;

use crafty_actor::{SubscriptionStart, TopicRetentionOpts, TopicSubscriptionDef};
use crafty_proto::{DEFAULT_TOPIC_MAX_EVENT_AGE_MS, DEFAULT_TOPIC_MAX_RETAINED_EVENTS};
