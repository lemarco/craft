...
use crafty_proto::TwoPhaseJournalCommand;
...
fn journal_key(tx_id: &[u8]) -> String {
    format!("crafty:2pc:{}", String::from_utf8_lossy(tx_id))
}
...
/// Metrics hook suitable for [`crafty_client::RunTwoPhaseOpts::on_event`].
#[must_use]
