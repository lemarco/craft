//! Advanced cluster APIs — Raft builder, journals, queues, autoscale, 2PC.
//!
//! Product apps usually import [`crate::prelude`] only; reach for this module when
//! extending [`CraftyCluster`](crate::cluster::CraftyCluster) or wiring custom storage.
