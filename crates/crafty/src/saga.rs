...
use crafty_actor::{ActorStateStore, NodeHandle};
use crafty_client::{
...
use crafty_dashboard::Metrics;
use crafty_proto::SagaJournalCommand;
...
fn journal_key(saga_id: &[u8]) -> String {
    format!("crafty:saga:{}", String::from_utf8_lossy(saga_id))
}
...
/// Metrics hook suitable for [`crafty_client::RunSagaOpts::on_event`].
#[must_use]
