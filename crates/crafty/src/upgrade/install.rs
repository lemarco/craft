...
/// Running application version ( `CRAFTY_APP_VERSION` or compile-time package version).
#[must_use]
pub fn running_app_version() -> String {
    std::env::var("CRAFTY_APP_VERSION").unwrap_or_else(|_| env!("CARGO_PKG_VERSION").to_string())
}
