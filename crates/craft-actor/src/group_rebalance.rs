//! Leader-triggered multi-Raft group placement (write-sharding-multi-raft control plane).
...
/// Computes rendezvous group placement and the local rebalance diff (write-sharding-multi-raft).
