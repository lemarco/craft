//! `crafty-store-redis` — Redis implementation of
...
//! Raft [`StateMachine`](crafty_actor::crafty_core::StateMachine) — Redis holds
//! only workflow/session/idempotency state.
//!
//! ```no_run
//! use std::sync::Arc;
//! use crafty_actor::ActorStateStore;
//! use crafty_store_redis::RedisStore;
//!
...
use crafty_actor::{ActorStateStore, BoxFuture, StoreError};
