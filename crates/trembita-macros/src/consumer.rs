...
pub(crate) fn expand_consumer(
    ...
    let (impl_job, impl_topic) = if subscription.is_some() {
        (
            ...
            quote! {
                ...
                async fn handle_topic(
                    payload: &[u8],
                    #ctx_binding: ::trembita::TopicContext<'_>,
                ) -> ::core::result::Result<(), Self::Error> {
                    #call
                }
            },
        ...
        (
            quote! {
                ...
                async fn handle_job(
                    payload: &[u8],
                    #ctx_binding: ::trembita::JobContext<'_>,
                ) -> ::core::result::Result<(), Self::Error> {
                    #call
                }
            },
    ...
    quote! {
        ...
        impl ::trembita::JobConsumer for #consumer_name {
